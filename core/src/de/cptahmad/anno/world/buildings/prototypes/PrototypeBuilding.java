...
public abstract class PrototypeBuilding extends Entity
{
    public final int width, height;

    private static int s_idGenerator = 0;

    public PrototypeBuilding(String name, int width, int height, @NotNull Texture texture)
    {
    ...
    {
        return Buildings.getRecipe(this);
    }
}
